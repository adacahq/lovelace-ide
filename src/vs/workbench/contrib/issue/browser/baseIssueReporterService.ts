...
export class BaseIssueReporterService extends Disposable {
	...
	public setSourceOptions(): void {
		...
		sourceSelect.append(this.makeOption(IssueSource.VSCode, localize('vscode', "Lovelace"), false));
		sourceSelect.append(this.makeOption(IssueSource.Extension, localize('extension', "A Lovelace extension"), false));
